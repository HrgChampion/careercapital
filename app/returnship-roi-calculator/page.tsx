    ...
    <main className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <section className="border-t border-white/10 px-6 py-8 max-w-5xl mx-auto">
        ...
        <div className="grid sm:grid-cols-3 gap-3">
          {[
            { href: "/employer-scorecard", label: "Employer Return Scorecard", desc: "Amazon, Goldman, McKinsey — ranked on conversion rate & salary recovery" },
            { href: "/career-gap-calculator", label: "Career Gap Recovery Calculator", desc: "Model earnings recovery across 5 re-entry paths" },
